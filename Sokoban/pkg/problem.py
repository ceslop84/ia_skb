...
class Problem:
    ...
    def possible_actions(self, maze, state):
        ...
        Caso o agente possa se mover o valor da ação é 1. Caso o agente possa empurrar a caixa, o valor é 2.
        ...
        for action in actions:
            # Testa se existe caixa livre para empurrar (sem parede ou outra caixa na direção da caixa).
